                ...
                <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="flex-1 w-full">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                            <ScoreBar label="Tech Skill (40%)" value={skill_score} />
                            <ScoreBar label="Soft Skill (15%)" value={soft_skill_score} />
                            <ScoreBar label="Languages (10%)" value={language_score} />
                            <ScoreBar label="Project Align (10%)" value={project_score} />
                            <ScoreBar label="Exp Match (15%)" value={experience_score} />
                            <ScoreBar label="Domain Align (10%)" value={domain_score} />
                        </div>

                        <p className="text-[10px] text-gray-500 mt-6 font-mono leading-relaxed">
                            Ranking Formula: 0.4×Tech + 0.15×Exp + 0.1×Domain + 0.15×Soft + 0.1×Lang + 0.1×Proj = {final_score.toFixed(1)}%
                        </p>
                    </div>
                </div>
            </div>
